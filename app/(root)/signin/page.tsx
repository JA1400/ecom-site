  ...
  return (
    <>
      ...
      <section className="min-h-60 p-5 pt-0 w-full flex flex-col justify-center items-center gap-2.5 bg-white">
        <form
          className="w-full bg-black text-white box-border border border-[#E2E2E2] rounded-md p-4 flex justify-center "
          action={async () => {
            "use server";
            await signIn("github");
          }}
        ...
        <form
          className="w-full box-border border border-[#E2E2E2] rounded-md p-4 flex justify-center"
          action={async () => {
            "use server";
            await signIn("google");
          }}
